...
public class Ed25519SignatureNative implements ISignature {
  private final Map<String, TweetNaclFast.Signature> cache =
      Collections.synchronizedMap(new CachedHashMap<>(5000));
