 ...
 *
 * <p>Used for requests to remote peers.
 */
public class JrpcServiceProxy {
    ...
    try {
      ...
      if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
        ...
        InputStream inputStream =
            ceHeader != null && ceHeader.toLowerCase(Locale.ENGLISH).equals("gzip")
  ...
  static class JsonRpcRequestSerializer extends StdSerializer<JsonRpcRequest> {
    ...
    @Override
    public void serialize(JsonRpcRequest value, JsonGenerator gen, SerializerProvider provider)
        throws IOException {
