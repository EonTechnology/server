...
public class DummyServiceTest {
  ...
  public void parse_error() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_parse_error.json",
  ...
  public void invalid_request() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_invalid_version.json",
  ...
  public void method_not_found() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_method_not_found.json",
  ...
  public void server_error() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_server_error.json",
  ...
  public void invalid_params() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_invalid_params.json",
  ...
  public void success() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_success.json",
  ...
  public void success_1() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_success_1.json",
  ...
  public void success_2() throws Exception {
    checkRequest(
        "/org/eontechnology/and/jsonrpc/request_success_2.json",
