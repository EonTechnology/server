package org.eontechology.and.peer.core.blockchain.storage.converters;
...
public class DTOConverterTest {
    ...
    public void transaction_contains_reference() throws Exception {
        ...
        Transaction a = Builder.newTransaction(timestamp).attach(null).refBy(referencedTx).build(networkID, signer);
        Transaction b = DTOConverter.convert(DTOConverter.convert(a));
    ...
    private void assetEquals(Transaction a, Transaction b) {
        ...
        if (a.getData() == null) {
            ...
            Assert.assertEquals(Format.convert(bencode.encode(a.getData())),
                                Format.convert(bencode.encode(b.getData())));
        }
