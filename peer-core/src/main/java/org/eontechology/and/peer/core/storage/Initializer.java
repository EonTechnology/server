package org.eontechology.and.peer.core.storage;
...
import org.eontechology.and.peer.core.storage.migrate.DBInitMigrateAction;
import org.eontechology.and.peer.core.storage.migrate.DBv2MigrateAction;
import org.eontechology.and.peer.core.storage.migrate.DBv3MigrateAction;
import org.eontechology.and.peer.core.storage.migrate.DBv4MigrateAction;
import org.eontechology.and.peer.core.storage.migrate.IMigrate;
...
public class Initializer implements IInitializer {
    ...
    private int migrate(List<IMigrate> actualMigrates) throws IOException, SQLException {
        ...
        for (IMigrate migrate : actualMigrates) {
            Loggers.info(Initializer.class,
        ...
        for (IMigrate migrate : actualMigrates) {
            Loggers.info(Initializer.class, "Data migration (up to version " + migrate.getTargetVersion() + ")...");
