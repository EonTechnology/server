package org.eontechology.and.peer.core.blockchain.events;

import java.util.List;
import java.util.Objects;

import org.eontechology.and.peer.core.common.events.DispatchableEvent;
import org.eontechology.and.peer.core.common.events.Dispatcher;
...
public class BlockchainEventManager {
    ...
    public void raiseBlockchainChanged(Object source, Block newLastBlock, List<Transaction> forked) {
        blockEventSupport.raiseEvent(new DispatchableEvent<IBlockchainEventListener, UpdatedBlockchainEvent>(new UpdatedBlockchainEvent(
                source,
                newLastBlock,
                forked)) {
            @Override
    ...
    public void raiseBlockchainChanging(Object source, Block oldLastBlock) {
        blockEventSupport.raiseEvent(new DispatchableEvent<IBlockchainEventListener, BlockchainEvent>(new BlockchainEvent(
                source,
                oldLastBlock)) {
            @Override
