...
public class BacklogEventManager {
  ...
  public void raiseClear(Object source) {
    backlogEventSupport.raiseEvent(
        new DispatchableEvent<IBacklogEventListener, BacklogEvent>(new BacklogEvent(source)) {
          @Override
  ...
  public void raiseUpdating(Object source, Transaction transaction) {
    backlogEventSupport.raiseEvent(
        new DispatchableEvent<IBacklogEventListener, BacklogUpdateEvent>(
            new BacklogUpdateEvent(source, transaction)) {
          @Override
  ...
  public void raiseRejected(Object source, Transaction transaction, RejectionReason reason) {
    backlogEventSupport.raiseEvent(
        new DispatchableEvent<IBacklogEventListener, BacklogRejectEvent>(
            new BacklogRejectEvent(source, transaction, reason)) {
          @Override
