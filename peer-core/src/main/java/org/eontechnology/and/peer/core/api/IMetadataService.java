...
/**
 * The {@code IMetadataService} interface must implement each env. Used to get the network
 * structure.
 */
public interface IMetadataService {
   ...
   * @return <code>true</code> if per added to server peer list, otherwise <code>false</code>
   * @throws RemotePeerException An error in the protocol.
   * @throws IOException Error during access to the services env.
   */
