...
public class PeerRegistry {
  ...
  /**
   * Registers an unknown env and returns object associated with it. If the env with the specified
   * {@code address} is already registered, the object associated with it will be returned.
   *
  ...
  /**
   * Returns an object associated with the env which has the specified {@code address} or null if
  ...
  /**
   * Returns an object associated with the env which has the specified {@code ip} or null if the
