...
public class StateTree<T> implements Iterable<T> {
  ...
  public StateTree(
      ITreeNodeConverter<T> valueConverter, ITreeNodeCollection nodes, TreeNode rootNode) {
  ...
  private static TreeNode createNewRoot(
      ITreeNodeCollection nodes, TreeNode rootNode, TreeNode newNode) {
  ...
  public static class TreeNodeIterator<V> implements Iterator<V> {
    ...
    TreeNodeIterator(
        ITreeNodeCollection nodes, TreeNode rootNode, ITreeNodeConverter<V> valueConverter) {
      this.valueConverter = valueConverter;
      this.nodes = nodes;
