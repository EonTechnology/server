...
/**
 * Class {@code Transaction} is used to indicate some data signed by the sender, which contains a
 * description of some action - an atomic change of the system state.
 */
public class Transaction extends SignedMessage {
  ...
  /**
   * Sets the lifetime of the transaction. The unit (assumed) is equal to seconds.
   *
   * @param deadline
   */
  ...
  /**
   * Returns the ID of the linked transaction. Linked transaction must be added to the block before
  ...
  /**
   * Sets the ID of the linked transaction. Linked transaction must be added to the block before the
   * current transaction.
   *
   * @param reference
   */
   ...
   *
   * @return map which contains a list of accounts that have confirmed the transaction.
   *     <p>The key is the friendly ID of account. To get an id call {@link
   *     AccountID#AccountID(String)}
   *     <p>The value is the signature. To convert to an array of bytes {@link Format#convert}
   */
