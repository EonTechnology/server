 ...
 *
 * <p>Contains reference for next and previous block, contains transactions, processed in block.
 */
public class Block extends SignedMessage implements Serializable {
  ...
  /**
   * Returns the special field "signature generation" in order to prove possession address
   *
   * @return
   */
  ...
  /**
   * Sets the special field "signature generation" in order to prove possession address
   *
  ...
  /**
   * Returns the hash of the snapshot where the current state of accounts is saved.
   *
   * @return
   */
