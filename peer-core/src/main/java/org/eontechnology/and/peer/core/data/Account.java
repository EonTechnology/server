 ...
 *
 * <p>An account is treated as a set of properties that are changed through transactions. The
 * property specification is defined in the transaction type.
 */
public class Account {
  ...
  /**
   * Adds a given {@code property}. If the property already exists, then its will be updated.
   *
   * @param prop
   * @return new account
   */
