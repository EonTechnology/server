...
/**
 * The {@code IBacklog} interface provides an abstraction for accessing the Backlog Buffer
 *
 * <p>The Backlog Buffer stores unconfirmed transactions
 */
public interface IBacklog extends Iterable<TransactionID> {
   ...
   * @throws ValidateException If some property of the specified <code>transaction</code> prevents
