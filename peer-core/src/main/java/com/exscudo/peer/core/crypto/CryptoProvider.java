...
public class CryptoProvider {
     ...
     *
     * @param name of the algorithm used by default
     */
     ...
     *
     * @param provider to add to the list of known. can not be null.
     */
     ...
     *
     * @param algorithm used to sign {@code messages}
     ...
     *                                       is null
     * @throws UnsupportedOperationException if the specified {@code  algorithm} is not supported
     */
     ...
     * @throws NullPointerException          if the {@code message} or {@code signature} or {@code publicKey}
     *                                       is null
     * @throws UnsupportedOperationException if the default algorithm is not specified
     */
     ...
     *
     * @param algorithm used to sign
     * @param object    for which a verification is performed
     * @param publicKey used by the signer
     * @return true if verification succeeded, otherwise - false.
     * @throws NullPointerException          if the {@code object} or {@code publicKey} is null. Also, if
