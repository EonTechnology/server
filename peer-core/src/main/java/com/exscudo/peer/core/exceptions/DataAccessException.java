package com.exscudo.peer.core.exceptions;
...
public class DataAccessException extends RuntimeException {
	 ...
	 * 
	 * @param cause
	 *            Cause if the error is associated with a exception. The null value
	 ...
	 *            the detail message.
	 * @param cause
	 *            the cause. The null value is permitted and indicates that the
