...
import com.exscudo.eon.DefaultBacklog;
...
public class AccountServiceTest {
    ...
    public void setup() throws Exception {
        ...
        service = Mockito.spy(new AccountService(backlog, mock(LedgerProvider.class), mock(IBlockchainService.class)));
    ...
    public void getState_for_existing_account_should_return_OK() throws Exception {
        ...
        assertEquals(AccountService.State.OK, service.getState(id.toString()));
    }
    ...
    public void getState_for_processing_account() throws Exception {
        ...
        Transaction tx = RegistrationBuilder.createNew(newAccount.getPublicKey()).build(sender);
        backlog.put(tx);

        AccountID id = new AccountID(newAccount.getPublicKey());
        assertEquals(AccountService.State.Processing, service.getState(id.toString()));
    }

    @Test
    public void getState_for_notexisting_account() throws Exception {
        assertEquals(AccountService.State.NotFound, service.getState(new AccountID(12345L).toString()));
    }
    ...
    public void getBalance_for_existing_account() throws Exception {
        ...
        AccountService.EONBalance balance = service.getBalance(id.toString());
    ...
    public void getBalance_for_notexisting_account() throws Exception {
        AccountService.EONBalance balance = service.getBalance(new AccountID(12345L).toString());
    ...
    public void getInformation_for_existing_account() throws Exception {
        ...
        AccountService.Info info = service.getInformation(id.toString());
    ...
    public void getInformation_for_notexisting_account() throws Exception {
        AccountService.Info info = service.getInformation(new AccountID(12345L).toString());
