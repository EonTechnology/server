...
public class GenerationTestIT {
    ...
    public void step_3_generate_block() throws Exception {
        ...
        Block generatedBlock = ctx.blockExplorerService.getById(newLastBlock.getID().toString());
    ...
    public void step_6_CallSyncBlock() throws Exception {
        ...
        Block generatedBlock = ctx2.blockExplorerService.getById(lastBlock2.getID().toString());
    ...
    public void step10_generator_should_use_trs_of_parallel_block() throws Exception {
        ...
        Assert.assertNull(ctx1.blockExplorerService.getById(lastBlockID.toString()));
    }
}
