...
public class PeerStarterTest {
    ...
    public void testBlockIds() throws Exception {
        ...
        Assert.assertEquals(blockchainProvider.getLastBlock().getID().getValue(), lastBlockId.getValue());
    ...
    public void forksTest_OK() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks.json",
                                         true);
    ...
    public void forksTest_err_add_cast_exception() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks_err_add_cast_exception.json",
                                         true);
    ...
    public void forksTest_err_re_adding_parser() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks_err_add_re_adding.json",
                                         true);
    ...
    public void forksTest_err_unknown_parser() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks_err_add_unknown_parser.json",
                                         true);
    ...
    public void forksTest_err_add_unknown_type_parser() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks_err_add_unknwon_type.json",
                                         true);
    ...
    public void forksTest_err_del_parser() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks_err_del.json",
                                         true);
    ...
    public void forksTest_err_format() throws Exception {
        ...
        PeerStarter peerStarter = create(connectURI,
                                         "org/eontechology/and/eon/app/IT/genesis_block.json",
                                         "org/eontechology/and/eon/app/IT/forks_err_format.json",
                                         true);
