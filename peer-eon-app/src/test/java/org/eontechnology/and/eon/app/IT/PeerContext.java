...
class PeerContext {
  ...
  PeerContext(PeerStarter starter) throws SQLException, IOException, ClassNotFoundException {
    ...
    transactionBotService =
        new TransactionBotService(starter.getBacklog()) {
          @Override
    ...
    syncTransactionPeerService =
        new ITransactionSynchronizationService() {
    ...
    syncBlockPeerService =
        new IBlockSynchronizationService() {
          ...
          @Override
          public Block[] getBlockHistory(String[] blockSequence)
              throws RemotePeerException, IOException {
            ObjectMapper mapper = ObjectMapperProvider.createMapper();
    ...
    syncMetadataPeerService =
        new IMetadataService() {
          ...
          @Override
          public boolean addPeer(long peerID, String address)
              throws RemotePeerException, IOException {
    ...
    syncSnapshotService =
        new ISnapshotSynchronizationService() {
  ...
  public void generateBlockForNow() {
    ...
    } while (fork.getNextBlockTimestamp(lastBlock.getTimestamp()) < timeProvider.get()
  ...
  public void setPeerToConnect(PeerContext ctx) {
    context.setProxyFactory(
        new IServiceProxyFactory() {
