...
public class PublicAccountTestIT {
  ...
  private void prepare_peer() throws Exception {
    ...
    Transaction tx3 =
        DelegateBuilder.createNew(new AccountID(delegate_1.getPublicKey()), 100)
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner());
    Transaction tx4 =
        DelegateBuilder.createNew(new AccountID(delegate_2.getPublicKey()), 100)
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner());
    ...
    Transaction tx5 =
        PaymentBuilder.createNew(1000000L, new AccountID(delegate_1.getPublicKey()))
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner());
    Transaction tx6 =
        PaymentBuilder.createNew(1000000L, new AccountID(delegate_2.getPublicKey()))
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner());
    ...
    Transaction tx =
        DelegateBuilder.createNew(new AccountID(ctx.getSigner().getPublicKey()), 0)
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner());
  ...
  public void step_0_PrePublicAccCanNotSign() throws Exception {
    ...
    Transaction tx5 =
        PaymentBuilder.createNew(10, publicAccId)
            .validity(timestamp, 3600)
            .payedBy(publicAccId)
  ...
  public void step_1_PublicAccNormal() throws Exception {
    ...
    // Generate 1 day
    Mockito.when(mockTimeProvider.get()).thenReturn(timestamp + Constant.SECONDS_IN_DAY + 1);
    ...
    Transaction tx =
        PublicationBuilder.createNew(GENERATOR)
            .validity(timestamp, 3600)
    ...
    Assert.assertEquals(
        GENERATOR,
        ctx.accountBotService.getInformation(
                new AccountID(ctx.getSigner().getPublicKey()).toString())
            .seed);
    ...
    Mockito.when(mockTimeProvider.get()).thenReturn(timestamp + 180 + 1);
    Transaction tx2 =
        DelegateBuilder.createNew(new AccountID(ctx.getSigner().getPublicKey()), 100)
            .validity(timestamp, 3600)
    ...
    // Weight up
    Transaction tx3 =
        DelegateBuilder.createNew(new AccountID(ctx.getSigner().getPublicKey()), 80)
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner(), new ISigner[] {delegate_1});
    ...
    Transaction tx4 =
        PaymentBuilder.createNew(10L, new AccountID(delegate_1.getPublicKey()))
            .validity(timestamp, 3600)
            .build(ctx.getNetworkID(), ctx.getSigner(), new ISigner[] {delegate_1});
  ...
  public void step_2_PublicAccEarly() throws Exception {
    ...
    // Generate 0.5 days
    Mockito.when(mockTimeProvider.get()).thenReturn(timestamp + Constant.SECONDS_IN_DAY / 2 + 1);
