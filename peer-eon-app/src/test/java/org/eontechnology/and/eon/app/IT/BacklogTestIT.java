...
public class BacklogTestIT {
  ...
  public void step_1_backlog_load_forked_transactions() throws Exception {
    ...
    Transaction tx1 =
        PaymentBuilder.createNew(10000L, new AccountID(ctx2.getSigner().getPublicKey()))
    ...
    Assert.assertNotNull(
        "Tx1 in blockchain of ctx1", ctx1.transactionExplorerService.getById(tx1.getID()));
    Assert.assertNotNull(
        "Tx2 in blockchain of ctx2", ctx2.transactionExplorerService.getById(tx2.getID()));
