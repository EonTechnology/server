package org.eontechnology.and.eon.app.mapper;
...
public class TransportTransactionMapperTest {
  ...
  public void transaction_nested_transaction() throws Exception {
    ...
    checkTransaction(
        tx,
        "d5:billsd23:EON-T-T3E22-2SG3U-EN8MJd8:deadlinei3600e3:feei1e2:id23:EON-T-T3E22-2SG3U-EN8MJ6:sender21:EON-87VQX-TKLTD-3JJNK9:signature128:5ef562be95347e48689c4452aab8a1a8917673150b5097082587453c326672ad880212c5472b18fd344a5c0eea8a4349e8f5a942d003e198f8877c112c421a0f9:timestampi12345e4:typei1e7:versioni1ee23:EON-T-T3E22-2SVD9-JRXFPd8:deadlinei3600e3:feei1e2:id23:EON-T-T3E22-2SVD9-JRXFP6:sender21:EON-87VQX-TKLTD-3JJNK9:signature128:679eebe9f4f31ead05743f35197f305d83dfa643e5165afe9ce23eae1fab65c89864b562c5bba485588e8e6ea054e37ce5cba081980bfe24a99fc029dffcd10f9:timestampi12345e4:typei2e7:versioni1eee13:confirmationsd21:EON-87VQX-TKLTD-3JJNK128:022319d6100ab74b3c56d8ab3220af4a3202b806c79954c1efc2e273027f619c84c3169d2e808f977576423f36c3c92cb9a73c56e3da6909080a00f7b47b2b01e8:deadlinei3600e3:feei1e2:id23:EON-T-T3E22-2JK2T-YRNHZ6:sender21:EON-87VQX-TKLTD-3JJNK9:signature128:022319d6100ab74b3c56d8ab3220af4a3202b806c79954c1efc2e273027f619c84c3169d2e808f977576423f36c3c92cb9a73c56e3da6909080a00f7b47b2b019:timestampi12345e4:typei1e7:versioni1ee");
  }

  @Test
  public void transaction_payer() throws Exception {

    Transaction tx =
        (new TransactionBuilder(1))
            .forFee(1L)
            .validity(12345, 3600)
            .payedBy(new AccountID(-1))
            .build(networkID, signer);
    checkTransaction(
        tx,
        "d8:deadlinei3600e3:feei1e2:id23:EON-T-T3E22-2WNQR-F72TM5:payer21:EON-ZZZZZ-ZZZZZ-ZZZ9J6:sender21:EON-87VQX-TKLTD-3JJNK9:signature128:e356697ac66fd29c8708ca556ab652d53c30e33ad442e78693fe8e7ca89a4284ad00aa404854817b3fe615d72104a2af44c9650ae77a09ad9b1d07fe2f15a1059:timestampi12345e4:typei1e7:versioni1ee");
  }
  ...
  public void transaction_account_registration() throws Exception {
    Transaction tx =
        RegistrationBuilder.createNew(signer.getPublicKey())
  ...
  public void transaction_delegate() throws Exception {
    Transaction tx =
        DelegateBuilder.createNew(new AccountID(1L), 10)
            .validity(12345, 3600)
            .build(networkID, signer);
  ...
  public void transaction_rejection() throws Exception {
    Transaction tx =
        RejectionBuilder.createNew(new AccountID(1L))
            .validity(12345, 3600)
            .build(networkID, signer);
  ...
  public void transaction_account_publication() throws Exception {
    Transaction tx =
        PublicationBuilder.createNew("112233445566778899qqwweerrttyyuu")
            .validity(12345, 3600)
            .build(networkID, signer);
  ...
  public void transaction_colored_coin_registration() throws Exception {
    Transaction tx =
        ColoredCoinRegistrationBuilder.createNew(1000L, 2)
            .validity(12345, 3600)
            .build(networkID, signer);
  ...
  public void transaction_colored_coin_payment() throws Exception {
    Transaction tx =
        ColoredPaymentBuilder.createNew(100L, new ColoredCoinID(9999999L), new AccountID(1111L))
            .validity(12345, 3600)
            .build(networkID, signer);
  ...
  public void transaction_colored_coin_supply() throws Exception {
    Transaction tx =
        ColoredCoinSupplyBuilder.createNew(2000L).validity(12345, 3600).build(networkID, signer);
  ...
  public void transaction_complex_payment() throws Exception {
    Transaction tx =
        ComplexPaymentBuilder.createNew(
                new Transaction[] {
                  PaymentBuilder.createNew(100L, new AccountID(0L))
                      .validity(12345, 3600)
                      .build(networkID, signer)
                })
            .validity(12345, 3600)
  ...
  public void transaction_note_1() throws Exception {
    ...
    Transaction tx =
        (new TransactionBuilder(1))
            ...
            .validity(12345, 3600)
            .refBy(new TransactionID(-1))
            .addNote("0123456789 abcdefghijklmnoprstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ #@*-_")
            .build(networkID, signer);
    checkTransaction(
        tx,
        "d8:deadlinei3600e3:feei1e2:id23:EON-T-T3E22-22WPQ-X3DDP4:note69:0123456789 abcdefghijklmnoprstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ #@*-_9:reference23:EON-T-ZZZZZ-ZZZZZ-ZZZ9J6:sender21:EON-87VQX-TKLTD-3JJNK9:signature128:4ae62a4b2efca2b625e158ecc2f3b59131e47b46f83ed1b58bd3d93be316f2f2db2f03f60f22e93d1e9a5b05bac64b29ce75b38cffa6e1f8dadbdbdd6bcbe8019:timestampi12345e4:typei1e7:versioni1ee");
  }

  @Test
  public void transaction_note_2() throws Exception {
  ...
  private void checkTransaction(Transaction tran, String data) throws IllegalArgumentException {
    byte[] bytes = bencode.encode(TransportTransactionMapper.convert(tran));
    String s = new String(bytes);
    Assert.assertEquals(data, s);

    Map<String, Object> decoded = bencode.decode(data.getBytes(), Type.DICTIONARY);
    assertEquals(tran, TransportTransactionMapper.convert(decoded));
  }
