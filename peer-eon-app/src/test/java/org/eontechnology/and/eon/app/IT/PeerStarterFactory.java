            ...
            List<String> validationRules = new ArrayList<String>() {
                {
                    ...
                    add("org.eontechnology.and.peer.core.middleware.rules.ReferencedTransactionValidationRule");
                    ...
                    add("org.eontechnology.and.peer.core.middleware.rules.ExpiredTimestampValidationRule");
                    add("org.eontechnology.and.peer.core.middleware.rules.FutureTimestampValidationRule");
                    add("org.eontechnology.and.peer.core.middleware.rules.ConfirmationsSetValidationRule");
                    ...
                    add("org.eontechnology.and.peer.core.middleware.rules.NestedTransactionsValidationRule");
                }
            };
            for (ForkItem i : items) {
