...
public class BotServiceFactory {
  ...
  public AccountBotService getAccountBotService()
      throws SQLException, IOException, ClassNotFoundException {
    return new AccountBotService(
        starter.getBacklog(), starter.getLedgerProvider(), starter.getBlockchainProvider());
  }

  public ColoredCoinBotService getColoredCoinBotService()
      throws SQLException, IOException, ClassNotFoundException {
    return new ColoredCoinBotService(starter.getLedgerProvider(), starter.getBlockchainProvider());
  }

  public PropertiesBotService getPropertiesBotService()
      throws SQLException, IOException, ClassNotFoundException {
    return new PropertiesBotService(
        starter.getFork().getGenesisBlockID(), starter.getTimeProvider());
  }
  ...
  public TransactionHistoryBotService getTransactionHistoryBotService()
      throws SQLException, IOException, ClassNotFoundException {
    return new TransactionHistoryBotService(
        getBacklogService(), getTransactionService(), getBlockService());
  }

  public TransactionBotService getTransactionBotService()
      throws SQLException, IOException, ClassNotFoundException {
    return new TransactionBotService(starter.getBacklog());
  }

  public BlockchainExplorerService getBlockchainExplorerService()
      throws SQLException, IOException, ClassNotFoundException {
    return new BlockchainExplorerService(
        getBacklogService(), getTransactionService(), getBlockService());
  }
  ...
  public BacklogService getBacklogService()
    ...
    return new BacklogService(
        starter.getBacklog(),
        starter.getFork(),
        new BacklogTimeProvider(starter.getBlockchainProvider(), starter.getFork()));
  }
  ...
  private static class BacklogTimeProvider implements ITimeProvider {
    ...
    private BacklogTimeProvider(IBlockchainProvider blockchainProvider, IFork fork) {
    ...
    @Override
    public int get() {
      return fork.getNextBlockTimestamp(blockchainProvider.getLastBlock().getTimestamp());
    }
  }
}
