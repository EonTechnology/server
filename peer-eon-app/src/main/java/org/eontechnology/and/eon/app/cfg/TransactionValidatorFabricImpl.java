...
public class TransactionValidatorFabricImpl implements TransactionValidatorFabric {
  ...
  @Override
  public TransactionValidator getAllValidators(
      ITimeProvider blockProvider, ITimeProvider peerProvider) {
    ...
    if (names.contains(NestedTransactionsValidationRule.class.getName())) {
      rules.add(
          new NestedTransactionsValidationRule(
              forkItem.getTransactionTypes(), blockProvider, accountHelper));
    }
