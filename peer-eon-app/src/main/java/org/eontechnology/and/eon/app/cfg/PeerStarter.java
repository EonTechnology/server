...
public class PeerStarter {
    ...
    public JrpcServiceProxyFactory getProxyFactory() throws SQLException, IOException, ClassNotFoundException {
        if (proxyFactory == null) {
            ...
            clazzMapImpl.put("org.eontechnology.and.peer.core.api.IMetadataService",
                             "org.eontechnology.and.eon.app.jsonrpc.proxy.MetadataServiceProxy");

            clazzMap.put("org.eontechnology.and.peer.core.api.ITransactionSynchronizationService", "transactions");
            clazzMapImpl.put("org.eontechnology.and.peer.core.api.ITransactionSynchronizationService",
            ...
            clazzMapImpl.put("org.eontechnology.and.peer.core.api.IBlockSynchronizationService",
                             "org.eontechnology.and.eon.app.jsonrpc.proxy.BlockSynchronizationServiceProxy");

            clazzMap.put("org.eontechnology.and.peer.core.api.ISnapshotSynchronizationService", "snapshot");
            clazzMapImpl.put("org.eontechnology.and.peer.core.api.ISnapshotSynchronizationService",
