...
/** Basic implementation of the {@code ITransactionSynchronizationService} interface */
public class SyncTransactionService extends BaseService
  ...
  public SyncTransactionService(
      IFork fork, ITimeProvider timeProvider, IBacklog backlog, IBlockchainProvider blockchain) {
