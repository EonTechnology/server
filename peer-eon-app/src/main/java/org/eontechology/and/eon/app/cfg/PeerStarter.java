...
import org.eontechology.and.eon.app.jsonrpc.JrpcServiceProxyFactory;
import org.eontechology.and.eon.app.utils.TransactionEstimator;
import org.eontechology.and.peer.core.backlog.Backlog;
import org.eontechology.and.peer.core.backlog.BacklogCleaner;
import org.eontechology.and.peer.core.backlog.events.BacklogEventManager;
...
import org.eontechology.and.peer.core.blockchain.TransactionMapper;
import org.eontechology.and.peer.core.blockchain.events.BlockchainEventManager;
...
import org.eontechology.and.peer.core.importer.BlockGenerator;
import org.eontechology.and.peer.core.ledger.ILedger;
import org.eontechology.and.peer.core.ledger.LedgerProvider;
import org.eontechology.and.peer.core.storage.Initializer;
...
public class PeerStarter {
    ...
    public JrpcServiceProxyFactory getProxyFactory() throws SQLException, IOException, ClassNotFoundException {
        if (proxyFactory == null) {
            ...
            clazzMap.put("org.eontechology.and.peer.core.api.IMetadataService", "metadata");
            clazzMapImpl.put("org.eontechology.and.peer.core.api.IMetadataService",
                             "org.eontechology.and.eon.app.jsonrpc.proxy.MetadataServiceProxy");

            clazzMap.put("org.eontechology.and.peer.core.api.ITransactionSynchronizationService", "transactions");
            clazzMapImpl.put("org.eontechology.and.peer.core.api.ITransactionSynchronizationService",
                             "org.eontechology.and.eon.app.jsonrpc.proxy.TransactionSynchronizationServiceProxy");

            clazzMap.put("org.eontechology.and.peer.core.api.IBlockSynchronizationService", "blocks");
            clazzMapImpl.put("org.eontechology.and.peer.core.api.IBlockSynchronizationService",
                             "org.eontechology.and.eon.app.jsonrpc.proxy.BlockSynchronizationServiceProxy");

            clazzMap.put("org.eontechology.and.peer.core.api.ISnapshotSynchronizationService", "snapshot");
            clazzMapImpl.put("org.eontechology.and.peer.core.api.ISnapshotSynchronizationService",
                             "org.eontechology.and.eon.app.jsonrpc.proxy.SnapshotSynchronizationServiceProxy");
