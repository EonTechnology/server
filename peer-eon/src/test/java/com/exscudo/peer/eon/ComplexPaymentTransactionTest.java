...
public class ComplexPaymentTransactionTest extends AbstractTransactionTest {
    private ComplexPaymentParser parser;
    ...
    public void setUp() throws Exception {
        ...
        parser = new ComplexPaymentParser(CompositeTransactionParser.create()
