...
public class ColoredCoinSupplyTransactionTest {
  ...
  public static class ParametrizedPart extends AbstractTransactionTest {
    ...
    public static Iterable<Object[]> parsers() {
      return Arrays.asList(
          new Object[][] {{new ColoredCoinSupplyParserV2()}, {new ColoredCoinSupplyParserV1()}});
    }
    ...
    public void invalid_nested_transaction() throws Exception {
      ...
      Transaction tx =
          ColoredCoinSupplyBuilder.createNew(0L).addNested(innerTx).build(networkID, sender);
    ...
    public void invalid_attach() throws Exception {
      ...
      Transaction tx =
          new TransactionBuilder(TransactionType.ColoredCoinSupply, map).build(networkID, sender);
      validate(parser, tx);
    }
  ...
  public static class V2 extends AbstractTransactionTest {
    ...
    public void toggle_to_auto_emission_mode() throws Exception {
      ...
      AccountProperties.setProperty(
          senderAccount,
          new ColoredCoinProperty()
              .setAttributes(new ColoredCoinProperty.Attributes(0, 0))
              .setMoneySupply(50000L)
              .setEmitMode(ColoredCoinEmitMode.PRESET));
      AccountProperties.setProperty(
          senderAccount, new ColoredBalanceProperty().setBalance(10000L, id));
    ...
    public void change_money_supply_insufficient_balance() throws Exception {
      ...
      AccountProperties.setProperty(
          ...
          new ColoredBalanceProperty()
              .setBalance(10000L, new ColoredCoinID(senderAccount.getID())));
