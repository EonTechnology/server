...
public class ColoredCoinRegistrationTransactionTest {
  ...
  public static class ParametrizedPart extends AbstractTransactionTest {
    ...
    public void invalid_attachment() throws Exception {
      ...
      Transaction tx =
          new TransactionBuilder(TransactionType.ColoredCoinRegistration, map)
    ...
    public void invalid_nested_transaction() throws Exception {
      ...
      Transaction tx =
          ColoredCoinRegistrationBuilder.createNew(1000000L, 1)
              .addNested(innerTx)
              .build(networkID, sender);
    ...
    public void re_enable() throws Exception {
      ...
      Transaction tx =
          ColoredCoinRegistrationBuilder.createNew(1000000L, 1).build(networkID, sender);
      validate(parser, tx);
    }
  ...
  public static class V2 extends AbstractTransactionTest {
    ...
    public void preset_emission_mode() throws Exception {
      ...
      Assert.assertTrue(AccountProperties.getColoredCoin(senderAccount).isIssued());
      Assert.assertEquals(
          AccountProperties.getColoredCoin(senderAccount).getMoneySupply(), 1000000L);
      Assert.assertEquals(
          AccountProperties.getColoredBalance(senderAccount)
              .getBalance(new ColoredCoinID(senderAccount.getID())),
          1000000L);
    }
