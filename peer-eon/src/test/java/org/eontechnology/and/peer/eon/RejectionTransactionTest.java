...
public class RejectionTransactionTest extends AbstractTransactionTest {
  ...
  public void setUp() throws Exception {
    ...
    AccountProperties.setProperty(
        delegateAccount, new RegistrationDataProperty(delegate.getPublicKey()));
    ...
    AccountProperties.setProperty(
        delegateAccount, new RegistrationDataProperty(delegate_1.getPublicKey()));
  ...
  public void invalid_attchment() throws Exception {
    ...
    Transaction tx =
        RejectionBuilder.createNew(baseAccount.getID())
