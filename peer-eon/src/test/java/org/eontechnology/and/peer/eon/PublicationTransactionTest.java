...
public class PublicationTransactionTest extends AbstractTransactionTest {
  ...
  public void unspecified_seed() throws Exception {
    ...
    map.put("param", "value");
    Transaction tx =
        new TransactionBuilder(TransactionType.Registration, map).build(networkID, signer);
    validate(parser, tx);
  }
  ...
  public void invalid_argument_number_in_attach() throws Exception {
    ...
    Transaction tx =
        new TransactionBuilder(TransactionType.Registration, new HashMap<>())
  ...
  public void invalid_uses_too_early() throws Exception {
    ...
    int timestamp = Constant.SECONDS_IN_DAY;
    ...
    int timestamp1 = timestamp + Constant.SECONDS_IN_DAY;
    Transaction tx =
        PublicationBuilder.createNew(seed)
            .validity(timestamp1 - 30 * 60, 60 * 60)
            .build(networkID, signer);
