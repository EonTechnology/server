...
import org.eontechnology.and.peer.eon.midleware.actions.ColoredCoinSupplyToAutoAction;
    ...
    if (!"auto".equals(data.get("supply"))) {
      ...
      supplyAction =
          new ColoredCoinSupplyToPresetAction(
              new ColoredCoinID(transaction.getSenderID().getValue()), newMoneySupply);
