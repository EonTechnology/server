...
public class ColoredBalancePropertySerializer
    extends AccountPropertySerializer<ColoredBalanceProperty> {
  ...
  @Override
  public Account doSerialize(ColoredBalanceProperty coloredBalance, Account account)
      throws IOException {
