...
public class RegistrationDataPropertySerializer
    extends AccountPropertySerializer<RegistrationDataProperty> {
  ...
  @Override
  public Account doSerialize(RegistrationDataProperty registrationData, Account account)
      throws IOException {
