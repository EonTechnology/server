...
public class ValidationModePropertySerializer
    extends AccountPropertySerializer<ValidationModeProperty> {
  ...
  @Override
  public Account doSerialize(ValidationModeProperty validationMode, Account account)
      throws IOException {
