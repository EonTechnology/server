...
public class GeneratingBalancePropertySerializer
    extends AccountPropertySerializer<GeneratingBalanceProperty> {
  ...
  @Override
  public Account doSerialize(GeneratingBalanceProperty generatingBalance, Account account)
      throws IOException {
